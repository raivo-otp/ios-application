...
target 'Raivo' do
  ...
  pod 'RealmSwift', '3.18.0', :inhibit_warnings => true
  ...
  pod 'Eureka', git: 'https://github.com/xmartlabs/Eureka.git', branch: 'xcode11', submodules: true, :inhibit_warnings => true
#  pod 'Eureka', '5.0.1', :inhibit_warnings => true
  pod 'ViewRow', '0.6', :inhibit_warnings => true
  
  # Retrieves, caches and displays images from the web (for issuer logos)
  pod 'SDWebImage', '5.1.1', :inhibit_warnings => true
  ...
  pod 'EFQRCode', '5.0.1', :inhibit_warnings => true
  
  # Swipable table view actions (for iOS < 11)
  pod 'SwipeCellKit', '2.7.0', :inhibit_warnings => true
